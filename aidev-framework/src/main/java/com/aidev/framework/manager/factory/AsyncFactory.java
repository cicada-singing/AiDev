package com.aidev.framework.manager.factory;
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                online.setStartTimestamp(DateUtils.toLocalDateTime(session.getStartTimestamp()));
                online.setLastAccessTime(DateUtils.toLocalDateTime(session.getLastAccessTime()));
