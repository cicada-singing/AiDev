package com.aidev.web.controller.demo.controller;
...
import com.aidev.common.json.JSONObject;
import com.aidev.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    public String cxselect(ModelMap mmap)
    {
        ...
        List<CxSelect> tmList = new ArrayList<>();
        ...
        List<CxSelect> jdList = new ArrayList<>();
    ...
    {
        String[] array = { "aidev 1", "aidev 2", "aidev 3", "aidev 4", "aidev 5" };
        AjaxResult ajax = new AjaxResult();
